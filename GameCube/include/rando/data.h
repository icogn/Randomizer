...
namespace mod::rando
{
    ...
    struct Header
    {
        ...
        /* 0x50 */ uint8_t heartColor;
        /* 0x51 */ uint8_t aButtonColor;
        /* 0x52 */ uint8_t bButtonColor;
        /* 0x53 */ uint8_t xButtonColor;
        /* 0x54 */ uint8_t yButtonColor;
        /* 0x55 */ uint8_t zButtonColor;
        /* 0x56 */ uint8_t lanternColor;
        /* 0x57 */ uint8_t transformAnywhere;
        /* 0x58 */ uint8_t quickTransform;
        /* 0x59 */ uint8_t castleRequirements;
        /* 0x5A */ uint8_t palaceRequirements;
        /* 0x5B */ uint8_t padding[3];
    } __attribute__( ( __packed__ ) );
